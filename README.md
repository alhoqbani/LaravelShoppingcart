## LaravelShoppingcart
[![Build Status](https://travis-ci.org/alhoqbani/LaravelShoppingcart.png?branch=master)](https://travis-ci.org/alhoqbani/LaravelShoppingcart)
[![Total Downloads](https://poser.pugx.org/alhoqbani/shoppingcart/downloads.png)](https://packagist.org/packages/alhoqbani/shoppingcart)
[![Latest Stable Version](https://poser.pugx.org/alhoqbani/shoppingcart/v/stable)](https://packagist.org/packages/alhoqbani/shoppingcart)
[![Latest Unstable Version](https://poser.pugx.org/alhoqbani/shoppingcart/v/unstable)](https://packagist.org/packages/alhoqbani/shoppingcart)
[![License](https://poser.pugx.org/alhoqbani/shoppingcart/license)](https://packagist.org/packages/alhoqbani/shoppingcart)

A simple shoppingcart implementation for Laravel.

> All rights reserved to original author of the library [Crinsane](https://github.com/Crinsane/LaravelShoppingcart)
...
Run the Composer require command from the Terminal:
    ...
    composer require alhoqbani/shoppingcart
...
Add a new line to the `providers` array:
	...
	Alhoqbani\Shoppingcart\ShoppingcartServiceProvider::class

And optionally add a new line to the `aliases` array:

	'Cart' => Alhoqbani\Shoppingcart\Facades\Cart::class,
...
If you want to change these options, you'll have to publish the `config` file.
    ...
    php artisan vendor:publish --provider="Alhoqbani\Shoppingcart\ShoppingcartServiceProvider" --tag="config"

This will give you a `cart.php` config file in which you can make the changes.

To make your life easy, the package also includes a ready to use `migration` which you can publish by running:

    php artisan vendor:publish --provider="Alhoqbani\Shoppingcart\ShoppingcartServiceProvider" --tag="migrations"
